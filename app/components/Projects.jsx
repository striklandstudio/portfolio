...
const projects = [
  ...
  {
    title: "Sierra Landscaping",
    description:
      "Portfolio-style site showcasing past landscaping projects with a quote-request form and before/after photo galleries.",
    tags: ["Next.js", "Cloudinary", "Forms"],
    url: "#",
